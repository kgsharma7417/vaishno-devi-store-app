...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-[90] flex flex-col items-end gap-2">
      {/* Tooltip bubble */}
      {showTooltip && (
        <div className="bg-white text-gray-800 text-xs font-medium px-3 py-2 rounded-lg shadow-medium border border-gray-100 max-w-[160px] text-right animate-fade-in">
